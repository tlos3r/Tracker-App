...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    ...
    <tbody class="divide-y divide-gray-200 bg-white">
      ...
      <tr>
        ...
        <td class="p-4 text-sm text-gray-600 ">
          ...
          <div class=" inline-block relative cursor-pointer"> <a
        ...
        <!-- Actions -->
        <td class="p-4 text-sm text-gray-600 flex justify-center items-center space-x-2 text-center">
          ...
          <form action="/transaction/<?php echo e($transaction['id']); ?>" method="POST" style="margin-bottom: 0;">
            <input type="hidden" name="_METHOD" value="DELETE" />
  ...
  <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
    ...
    <div class="-mt-px flex w-0 flex-1">
      ...
      <a href="/?<?php echo e($previousPageQuery); ?>" class="inline-flex items-center border-t-2 border-transparent pr-1 pt-4 text-sm font-medium text-gray-500
    ...
    <div class="-mt-px flex w-0 flex-1 justify-end">
      ...
      <a href=" /?<?php echo e($nextPageQuery); ?>" class="inline-flex items-center border-t-2 border-transparent pl-1 pt-4 text-sm font-medium text-gray-500
      hover:border-gray-300 hover:text-gray-700">
        Next
