...
<section class="max-w-2xl mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
  ...
  <form method="POST" class="grid grid-cols-1 gap-6">
    ...
    <label class="block">
      ...
      <input type="email" value="<?php echo e($oldFormData['email'] ?? ''); ?>"
    ...
    <label class="block">
      ...
      <input name="age" type="number" value="<?php echo e($oldFormData['age'] ?? ''); ?>"
        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        placeholder="" />
    ...
    <label class="block">
      ...
      <input type="text" value="<?php echo e($oldFormData['socialMediaUrl'] ?? ''); ?>"
        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        placeholder="" name="socialMediaUrl" />
    ...
    <label class="block">
      ...
      <?php if (array_key_exists('comfirmPassword', $errors)): ?>
      <div class="bg-gray-100 mt-2 text-red-500">
        <?php echo e($errors['comfirmPassword'][0]); ?>
      </div>
      <?php endif; ?>
    </label>
    <!-- Terms of Service -->
